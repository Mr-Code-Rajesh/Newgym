...
export default function GalleryHeader() {
  return (
    <div className="flex flex-col gap-4 text-center max-w-3xl mx-auto px-4">
      ...
      >
        Inside The Ultimate <br className="hidden sm:inline" />
      ...
      >
        Step into the arena where peak human biomechanics meets cinematic atmosphere. 
        Witness the fusion of high-performance energy, elite coaching, and premium design language.
      </motion.p>
    </div>
  );
}
