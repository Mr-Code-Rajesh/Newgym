...
export default function TestimonialHeader() {
  return (
    <div className="flex flex-col gap-4 text-center max-w-3xl mx-auto px-4 select-none">
      ...
      >
        What Our Members <br className="hidden sm:inline" />
      ...
      >
        True physical optimization is a collective biometrics journey. Witness the raw, documented achievements of individuals who redefined their threshold goals.
      </motion.p>
    </div>
  );
}
