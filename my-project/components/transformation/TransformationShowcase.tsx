...
export default function TransformationShowcase() {
  return (
    <section
      id="transformations"
      aria-label="Apex Biometrics Transformation Showcase"
    ...
    >
      {/* 1. Subtle cinematic ambient lights */}
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div className="absolute bottom-[20%] right-[-15%] w-[50vw] h-[50vw] max-w-[500px] rounded-full bg-zinc-200/40 dark:bg-zinc-900/10 blur-[130px] pointer-events-none" />
      </div>

      {/* 2. Heading and Motivation Header Block */}
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 flex flex-col items-center text-center gap-4">
        ...
        >
          Explore the biometric and neuromuscular logs of members who broke past their genetic limiters. Every evolution is backed by continuous physical telemetry and professional physiologist reviews.
        </motion.p>
      </div>

      {/* 3. The Core Transformation Grid */}
